...
def paramgen(policy_net=policy_net, i1=None, i2=None):
    ls1=["lin4e.weight", "lin5e.weight","lin4e.bias", "lin5e.bias"]
    ls2=["lin4f.weight", "lin5f.weight","lin4f.bias", "lin5f.bias"]
...
def select_action(state_p1=None, state_p2=None, state_p3=None,i1=None,i2=None):
    global steps_done
    ...
    if sample > eps_threshold:
        ...
        with torch.no_grad():
            if i2 is None:
                act=policy_net(x_p1=state_p1,x_p2=state_p2,x_p3=state_p3,i1=1)
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        #print(state)
        #print(state.shape)
        action1 = select_action(state_p1=state_p1,state_p2=state_p2, state_p3=state_p3,i1=1)
        action2 = select_action(state_p1=state_p1,state_p2=state_p2, state_p3=state_p3,i2=1)
