...
class env(AECEnv):
    ...
    def _setup_flight(self):
        ...
        #Controllable setup
        offset=0
        print(len(self.possible_landmarks))
        #method to randomly pick every site equally*
        if len(self.possible_landmarks) ==0:
            self.possible_landmarks=self.landmarks

        
        self.current_landmark=random.choice(self.possible_landmarks)
        self.possible_landmarks.remove(self.current_landmark)
