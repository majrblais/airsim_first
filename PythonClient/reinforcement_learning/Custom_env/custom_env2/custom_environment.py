...
class raw_env(SimpleEnv, EzPickle):
    def __init__(self,N=3,local_ratio=0.5,max_cycles=25,continuous_actions=False,render_mode=None,):
        EzPickle.__init__(self, N, local_ratio, max_cycles, continuous_actions, render_mode)
        ...
        self.observation_spaces = {i: spaces.Dict({"observation": spaces.Box(low=0, high=255, shape=(512, 512, 3), dtype=np.int8),})for i in self.agents}
