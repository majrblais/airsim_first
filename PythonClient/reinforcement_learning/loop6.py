...
result = offpolicy_trainer(policy,train_collector,test_collector=None, max_epoch=1, step_per_epoch=100, step_per_collect=5, episode_per_test=1, batch_size=4,update_per_step=0.5,logger=logger,save_checkpoint_fn=save_checkpoint_fn)
