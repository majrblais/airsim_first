...
class AirSimcustomEnv_base(gym.Env):
    def __init__(self,ip_address="127.0.0.1", step_length=1, image_shape=(84, 84, 1),):
        ...
        self.current_drone="DroneFollower0"
    ...
    def _setup_flight(self):
        ...
        self.drone.moveToPositionAsync(5, 0, -50, 10, vehicle_name="DroneFollower0").join()
        ...
        self.drone.moveToPositionAsync(-5, 0, -51, 10, vehicle_name="DroneFollower1").join()
        self.drone.moveByVelocityAsync(0, 0, 0, 1, vehicle_name="DroneFollower1").join()
        
        
    def step(self, action):
        
        if self.current_drone=="DroneFollower0":
        ...
        elif self.current_drone=="DroneFollower1":
            self._do_action(action)
    ...
    def _get_obs(self):
        ...
        if self.current_drone == "DroneFollower0":
            ...
            self.drone.simSetSegmentationObjectID("DroneFollower0", 10, True)
            ...
            self.drone.simSetSegmentationObjectID("[\w]*", 0, True)
            self.drone.simSetSegmentationObjectID("DroneFollower0", 20, True)
        ...
        collision0 = self.drone.simGetCollisionInfo(vehicle_name="DroneFollower0").has_collided
