...
class AirSimcustomEnv_base(gym.Env):
    ...
    def rand_mv(self):
        ...
        self.drone.moveByVelocityAsync(pos.x_val + quad_offset[0],pos.y_val + quad_offset[1],pos.z_val, 1, vehicle_name=self.agents[0].name).join()  
        ...
        self.drone.moveByVelocityAsync(pos.x_val + quad_offset[1],pos.y_val + quad_offset[1],pos.z_val, 1, vehicle_name=self.agents[1].name).join()  
    ...
    def _do_action(self,action):
        ...
        self.drone.moveByVelocityAsync(pos.x_val + quad_offset[0],pos.y_val + quad_offset[1],pos.z_val, 1, vehicle_name=self.trainer.name).join()  
    ...
    def _compute_reward(self):
        ...
        elif self.trainer.pos.x_val>=42 or self.trainer.pos.x_val<= -51 or self.trainer.pos.y_val >=44 or self.trainer.pos.y_val <=-44:
            reward = 0
            done=1
    ...
    def _get_obs(self):
        ...
        mask_[np.where((mask_ == [143, 149, 226]).all(axis=2))] = [21,21,21]
    ...
    #ttt=cv2.rectangle(ttt, (int(boxes[2][0]),int(boxes[2][1])), (int(boxes[2][2]),int(boxes[2][3])), (255, 0, 0),-1)
        ...
        ttt=cv2.rectangle(ttt, (int(boxes[3][0]),int(boxes[3][1])), (int(boxes[3][2]),int(boxes[3][3])), (100, 100, 255),-1)
