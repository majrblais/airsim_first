...
class AirSimcustomEnv_base(gym.Env):
    def __init__(self,ip_address="127.0.0.1", step_length=1, image_shape=(84, 84, 1),):
        ...
        self.state = {"position0": np.zeros(3),"position1": np.zeros(3),"position2": np.zeros(3),"collision0": False, "collision1": False, "collision2": False ,"prev_position0": np.zeros(3), "prev_position1": np.zeros(3), "prev_position2": np.zeros(3)}
    ...
    def _get_obs(self):
        ...
        responses = self.drone.simGetImages([self.image_request],vehicle_name="DroneLeader")
        ...
        collision0 = self.drone.simGetCollisionInfo(vehicle_name="DroneLeader").has_collided
        ...
        return self.drone_state0.kinematics_estimated.position,im_final, self.drone_state1.kinematics_estimated.position, self.drone_state2.kinematics_estimated.position
